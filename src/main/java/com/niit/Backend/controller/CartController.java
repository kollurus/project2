...
public class CartController {
	...
	public String addToCart(@RequestParam("quantity") int q, @PathVariable("id") String Productid,@PathVariable("userId") int userId,HttpSession session)throws Exception 
	{
